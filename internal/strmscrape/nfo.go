...
func writeMovieNFO(path, title, tmdbID, plot string, year *int, rating float64, actors ...nfoActor) error {
	return writeWorkNFO(path, "movie", title, tmdbID, plot, year, rating, actors)
}

func writeTVShowNFO(path, title, tmdbID, plot string, year *int, rating float64, actors ...nfoActor) error {
	return writeWorkNFO(path, "tvshow", title, tmdbID, plot, year, rating, actors)
}

func writeWorkNFO(path, root, title, tmdbID, plot string, year *int, rating float64, actors []nfoActor) error {
	nfo := workNFO{
