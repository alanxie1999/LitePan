...
func normalizeItemListQuery(in ItemListQuery) ItemListQuery {
	...
	switch out.Sort {
	case ItemListSortTitleAsc, ItemListSortYearDesc, ItemListSortYearAsc, ItemListSortAddedAsc, ItemListSortAddedDesc, ItemListSortRatingDesc, ItemListSortRatingAsc:
	default:
